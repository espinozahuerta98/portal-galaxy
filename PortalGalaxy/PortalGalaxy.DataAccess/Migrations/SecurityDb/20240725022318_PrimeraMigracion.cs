...
namespace PortalGalaxy.DataAccess.Migrations.SecurityDb
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloqueoHasta = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LockoutEnabled = table.Column<bool>(type: "bit", nullable: false),
                    NroIntentos = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
